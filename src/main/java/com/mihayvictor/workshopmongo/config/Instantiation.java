package com.mihayvictor.workshopmongo.config;
...
import com.mihayvictor.workshopmongo.dto.AuthorDTO;
import com.mihayvictor.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aprovaeite", sdf.parse("22/03/2018"), new AuthorDTO(bob));
